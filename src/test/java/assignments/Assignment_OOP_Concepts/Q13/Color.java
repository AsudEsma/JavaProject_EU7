...
public class Color {
    ...
    static String[] colorNames = {"WHITE","LIGHT_GRAY","GRAY","DARK_GRAY","BLACK","RED","PINK","ORANGE","YELLOW","GREEN","MAGENTA","CYAN","BLUE"};
    ...
    public String toString() {
        ...
        return outcome; //change this to return colors
    }
}
